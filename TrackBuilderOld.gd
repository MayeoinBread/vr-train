...
func create_rail_instance(base_transform: Transform3D, offset: float) -> void:
	#var rail_profile_array = PackedVector2Array(
		#[Vector2(0.00233, 0.0),
		#Vector2(0.00233, 0.035),
		#Vector2(0.026, 0.035),
		#Vector2(0.026, 0.09),
		#Vector2(0.0, 0.09),
		#Vector2(0.0, 0.145),
		#Vector2(0.06866, 0.145),
		#Vector2(0.06866, 0.09),
		#Vector2(0.04227, 0.09),
		#Vector2(0.04227, 0.035),
		#Vector2(0.06633, 0.035),
		#Vector2(0.06633, 0.0)]
	#)
